...
public class CustomerLargeYard implements Yard{
    ...
    public CustomerLargeYard(String lastName, String firstName, int size, int numberTrees, int gardenSize, String doubleDriveway) {
    ...
    public double getCost() {
        double baseFee = 0.003*(size-gardenSize);
